...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	  ...
	  */
	  var SubmissionCover = _react2.default.createClass({
	    ...
	    onWhichFormChange: function onWhichFormChange(e) {
	      this.setState({ form: e.target.value }, this.refreshList);
	    },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { id: 'subs-search-input', type: 'text' })
	              )
	            ),
	            _react2.default.createElement(
	              'span',
	  ...
	  var SubmissionView = _react2.default.createClass({
	    ...
	    render: function render() {
	      ...
	      for (var x in this.state.submissionContent) {
	        var submission = this.state.submissionContent[x];
	            ...
	            Object.keys(renderSubmission).map(function (pageIndex) {
	              ...
	              for (var field in thisPage) {
	                if (typeof thisPage[field].url !== 'undefined') {
	                  var tempValue = [];
	                  for (var _x in thisPage[field].value) {
	                    tempValue[_x] = '<a href="' + thisPage[field].url[_x] + '">' + thisPage[field].value[_x] + '</a>';
	                  }
	            ...
	            this.props.forms.map(function (form) {
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'span',
	                  { style: { width: '10%' } },
	                  _react2.default.createElement('i', { 'data-id': form.id, onClick: _this.props.onTrash.bind(null, form.id), className: 'trash-icon trash-form icon-trash-1' })
	                )
	              );
	            })
	          )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            this.props.data.map(function () {
	              var pageList = [];
	              for (var x = 1; x <= _this2.props.data[0]; x++) {
	                pageList.push(_react2.default.createElement(
	                  'span',
	                  { key: x, className: x === _this2.props.currentPage ? 'active' : '', onClick: _this2.props.updatePage.bind(null, x) },
	                  x
	                ));
	              }
	              return pageList;
	  ...
	  */
	  var AnalyticsCover = _react2.default.createClass({
	    ...
	    plotChart: function plotChart(labels, views, submissions, payments) {
	      ...
	      spinTo('#views', viewsSum);
	      spinTo('#submissions', submissionsSum);
	      spinTo('#conversion', conversion);
	      spinTo('#conversionPayments', conversionPayments);
	      spinTo('#payments', paymentsSum);
	...
	function spinTo(selector, to) {
	  var val = void 0;
	  var fromVal = jQuery(selector).text() === '' ? 0 : parseFloat(jQuery(selector).text());
	  to = isNaN(parseFloat(to)) ? 0 : parseFloat(to);
	  var duration = to - fromVal < 100 ? 200 : 700;
	  jQuery({ someValue: fromVal }).animate({ someValue: parseFloat(to) }, {
	    duration: duration,
	    easing: 'swing',
	    context: to,
	    step: function step() {
	      if (parseInt(to, 10) !== parseFloat(to)) {
